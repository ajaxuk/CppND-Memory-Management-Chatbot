...
ChatLogic::ChatLogic()
{
    ...
    // Instantiation of chatbot taken to method:LoadAnswerGraphFromFile
...
ChatLogic::~ChatLogic()
{
    ...
    // nodes are deleted from the heap automatically as unique_ptr
    // no need for Edges in ChatLogic since they are held as child and paretn edges
    // in Nodes class
